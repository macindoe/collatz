...
## 5.5. Transform `X_exit -> R`: Exit to Reduced State
...
This separates coordinate changes from the structural dynamics themselves. In particular, the reduced self-map may be viewed as the composition
...
Thus the map `F` acts intrinsically on reduced states, even though its derivation may be understood through the intermediate coordinate transforms.
