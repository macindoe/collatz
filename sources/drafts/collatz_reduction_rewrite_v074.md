...
open:
    ...
    control of C  (equivalently: the anchor increment law, 11.8.5.6),
    laws for d_+,
...
* how the anchor moves under the reduced step — the fiber-versus-orbit bridge posed in `11.8.5.6`,
