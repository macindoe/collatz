...
| `anchors.md` | §17: consolidated reference for the anchor across the wiki (pointers only, 17.1–17.6); the new single-sequence digit-structure search program (17.7–17.9, not yet executed) | REFERENCE + open search program |
