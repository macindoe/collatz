---
status: ACTIVE — predecessor structure and 3-adic mirror machinery exact and fully dualized (14.1–14.10); dead ends classified (14.5); rigorous density bound proved (14.6, c* = 0.3304; canonical five-lemma proof in paper 2); steering laws back-ported (14.12); KL–LP density refinement closed short of the 0.43 bar (14.6.5, 14.13, structural obstruction recorded); the door/exit seam proved and placed (14.14) — a total, constant-offset graded law for the 3-adic anchor along forward orbits, with the core-extraction deficit shown to relocate onto it exactly rather than dissolve; a corollary layer (14.14.7–14.14.8, block-map brief) reads G as T's own variable-return-time block map, strengthens the tightness law, and composes it along fixed itineraries, reconciling the periodic-word fixed point with the classical cycle candidate (cycles.md §12.1) — no change to the seam's or the Bridge's status; the itinerary language is now fully characterized at finite level (14.15) — the classical Collatz coding in door coordinates, a full shift with no finite-level rigidity to find, and a formulation-grade two-sided Z_2×Z_3 coding whose periodic points are the classical cycle candidate and whose general locus is the Bridge's symbolic name — no change to the Bridge's status; the unique-predecessor lemma, the finite bicylinder corollary (no finite two-sided obstruction, ever), and the positive realization height (an equivalent boundedness criterion for 14.15.3(c)'s diagonal locus) are proved (14.15.4, bicylinder-height brief) — no change to the Bridge's status; the converse of the trivial diagonal direction is proved (14.15.5, diagonal-converse brief) — the diagonal locus is exactly the positive-integer diagonal, a completed three-way characterization, with the periodic word ((2,1))^∞'s point identified as the classical negative T-cycle {-5,-7} — no change to the Bridge's status; the apparatus is restated over the nonzero odd integers (14.15.6, signed-diagonal brief) — sign-blind throughout apart from one one-sided asymmetry (G can output -1, forward mortality, negative sector only), the per-sector realization height's transfer from 14.15.4.4-14.15.4.5 checked step by step and found to hold, and the known negative cycles ({-5,-7}, the period-7 cycle as the G-period-2 word ((4,1),(3,3))) become ordinary diagonal points rather than boundary exceptions, with {-1} alone genuinely outside the coding — no change to the Bridge's status
