---
status: REFERENCE — consolidates the anchor concept across the wiki (pointers only, no proofs restated); owns the single-sequence digit-structure search (17.7-17.9), executed with a clean pass on both axes — breadth (17.7.1) and a 32×-deeper single-anchor probe (17.7.2) — no intra-sequence structure found beyond what is already proved or known
