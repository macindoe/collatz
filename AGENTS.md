...
- 2026-07-07 — general-p elimination (12.6.1) verified on random orbits p ∈ {3,4,5} + trivial-cycle identity R = 4^p − 3^p for p ∈ {1,2,3,4,7}; period-3 search (12.7.1): n <= 20,000, 76 treated n, 886 exact tests, no nontrivial solutions; prune audited on 4,798 cells (skipped region + box boundary), zero violations. Two filter-constant errors caught and corrected in-session (0.138→0.098; missing box branch); corrected run changed no outcomes. Code: experiments/period3_cycles.py.
