...
Each law above was checked by independently written code: the valuation law on $8{,}000$ random states across both lifting components; the entry-depth law exhaustively on all $62{,}937$ valid states with $\w < 3000$, $d < 64$; the absorption law on $60{,}000$ random states including $341$ boundary cases $d = h(s)$. Zero discrepancies. The entry-depth verification is recorded at \texttt{stage3.md} \S11.8.6.3 of the project record, and the independent re-verification of 2026-07-06 in that page's status header.
\end{remark}
