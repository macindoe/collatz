...
clauses of admissibility). Past that range the hypothesis supplies less, and only
...
that neither theorem supplies and that $\pi_{k,D}$ does; it is therefore a
consequence of Hypothesis~\ref{hyp:aeh} and not available to underwrite it. What
