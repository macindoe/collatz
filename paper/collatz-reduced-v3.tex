...
Consequently, combined with Rhin's effective bound \cite{rhin} in the form $K\log 2 - n\log 3 > \exp\bigl(-13.3\,(0.46057 + \log n)\bigr)$, the candidate set at every period is finite and explicitly bounded: $n \le n_0(p)$, the unique solution in $n$ of
