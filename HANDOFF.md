...
1. **Paper 2 referee passes.** v1 went through three external skeptical passes (ChatGPT) before publishing; paper 2 has had none. Same process: skeptical read focused on the density theorem's proof (Section 8) and the steering laws (Section 7), claim-calibration pass, then the author's note in Ben's voice (his words, not the model's), then Zenodo as a separate DOI.
