...
Thus the raw irregular halo is not family-specific. The family-specific data appears only in the placement of the template through the primary spike `d*(ω)`.

Equivalently, the halo shells are the odd multiples of descending powers of `2` around the centered origin:

```text
Δ = 0,
Δ = 2^7,
Δ = odd multiples of 2^6,
Δ = odd multiples of 2^5,
Δ = odd multiples of 2^4,
Δ = odd multiples of 2^3,
...
```

modulo `256`.

This suggests that the irregular branch has the following empirical structure:

```text
family-specific primary spike  +  universal centered dyadic halo template.
```

In this form, the irregular families no longer look like unrelated exceptions. They appear to realize one common shell architecture, translated by the position of the primary spike.
...
### 10.10. Primary congruence branch and 2-adic offset in the irregular branch
...
## 10.11. Status of These Observations
