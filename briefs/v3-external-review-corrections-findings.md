...
1. **§1 and the Contributions list** still assert unqualified finite-window determinism (item 2 above). — **Closed** on branch `v3-body-qualifier`; see `briefs/v3-body-qualifier-findings.md`.
